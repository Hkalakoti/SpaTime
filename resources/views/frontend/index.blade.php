...
<a href="{{route('index')}}" class="spa-time"><img src="images/spa-time-new.svg" alt="SPA_TIME" class="img-color-white"/><img src="images/spa-time-new-mobile.png" class="img-color-black" alt="SPA_TIME"/></a>	
		...
		<div class="wsmain">
			 <nav class="wsmenu clearfix"> 
				<ul class="mobile-sub wsmenu-list">
					...
					<li class="mobile-link-hide link-top-mobile"><a href="{{route('login')}}" class="user-link user-link-mobile"><img src="{{asset('images/user-mobile.svg')}}" class="img-fluid login-user" alt="Login"></a></li>
		            <li class="mobile-link-hide link-top-desktop"><a href="javascript:void(0);" class="main-link cart-link cart-link-mobile"><img src="{{asset('images/basket.png')}}" class="img-fluid basket-img" alt="Basket"></a></li>
					<li class="mobile-link-hide link-top-mobile"><a href="javascript:void(0);" class="main-link cart-link cart-link-mobile"><img src="{{asset('images/basket-mobile.png')}}" class="img-fluid basket-img" alt="Basket"></a>	
	...
	<div class="top-spa-left">
		<div class="mobile-search-bar">
          <div class="container searchbardiv" id="formsearch">
			...
			<button type="button" class="buttonsearch buttonsearch-desktop" id="buttonsearch">
			...
			<button type="button" class="buttonsearch buttonsearch-mobile" id="buttonsearch">
			<img src="images/top-icons/search1.png" class="img-fluid openclosesearch top-row-icon" alt="Search">
			<img src="images/top-icons/search1.png" class="img-fluid openclosesearch top-row-icon" alt="Search" style="display:none">		
		    </button>
					...
					<ul>	
					<li><a href="login.html"><div class="favourite-main">
                        <span class="favourite-icon"><img src="{{asset('images/icons/user.svg')}}" alt="Login" class="img-fluid"></span>
	                </div></a></li>
...
<section class="banner-main">
	...
	<p>Join our luxurious sanctuaries of health and wellness. Indulge in our spirit awakening rituals catered for your mind, body and soul. A serenity like no other. </p>
	<div class="banner-btns">	
	<a href="javascript:void(0)" class="rituals-btn black-button">View Rituals</a>
	<a href="javascript:void(0)" class="gifts-btn black-button">Gift Vouchers</a>
	</div>	
	</div>	
	</div>
</section>
...
<div class ="logModel logModel-home text-center wow fadeInUp">
	<p class="anim1">Got a gift from a friend? <br>Login to see all your gift and paid sessions</p><br>
	<div class="form-group anim2">
		<div class="double"><a href="javascript:void(0)">Login</a></div>
		<div class="double"><a href="javascript:void(0)">Sign Up</a></div>
	</div>	
	<div class="anim3">
	<h4>Quick Booking</h4>
	</div>
...
<div class="form-group anim4 signup-btn"><button type="submit" class="button-line button-line-home">Book Now</button>
</div>
</div>	
</div>	
</div>	
...
<section class="footer-copyrights">
	<div class="padding-left-right">
	<div class="container-fluid">
		<p class="copyright">Copyright © SPA TIME 2022. All Rrights Reserved</p>
		<p class="designed">Designed By <a href="https://www.design-master.com/" target="_blank">Design Master</a></p>
	</div>
	</div>	
</section>
