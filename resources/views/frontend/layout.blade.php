						...
						<div class="wsmain">
							<nav class="wsmenu clearfix">
								<ul class="mobile-sub wsmenu-list">
									<a href="{{route('home')}}" class="spa-time spa-time-mobile-logo"><img src="{{asset('images/spa-time-new.svg')}}" alt="SPA_TIME" /></a>
						...
						<div class="top-login top-login-mobile">
							<ul>
								<li><a href="login.html">
										<div class="favourite-main"><span class="favourite-icon"><img src="{{asset('images/icons/user.svg')}}" alt="Login" class="img-fluid"></span>
										</div>
									</a></li>
								<li><a href="javascript:void(0)">
										<div class="favourite-main cart-link"><span class="favourite-icon"><img src="{{asset('images/basket.png')}}" class="img-fluid basket-img" alt="Basket"></span>
										</div>
									</a></li>
							</ul>
						</div>
