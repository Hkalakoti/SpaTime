						...
						<div class="swiper-container gallery-top">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="gallery-large" data-src="{{asset('images/details/01.jpg')}}" data-fancybox="gallery">
										<img src="{{asset('images/details/01.jpg')}}" alt="gallery">
									</div>
								</div>

								<div class="swiper-slide">
									<div class="gallery-large" data-src="{{asset('images/details/02.jpg')}}" data-fancybox="gallery">
										<img src="{{asset('images/details/02.jpg')}}" alt="gallery">
									</div>
								</div>

								<div class="swiper-slide">
									<div class="gallery-large" data-src="images/details/03.jpg')}}" data-fancybox="gallery">
										<img src="{{asset('images/details/03.jpg')}}" alt="gallery">
									</div>
								</div>

								<div class="swiper-slide">
									<div class="gallery-large" data-src="{{asset('images/details/04.jpg')}}" data-fancybox="gallery">
										<img src="{{asset('images/details/04.jpg')}}" alt="gallery">
									</div>
								</div>

								<div class="swiper-slide">
									<div class="gallery-large" data-src="{{asset('images/details/05.jpg')}}" data-fancybox="gallery">
										<img src="{{asset('images/details/05.jpg')}}" alt="gallery">
									</div>
								</div>

								<div class="swiper-slide">
									<div class="gallery-large" data-src="{{asset('images/details/06.jpg')}}" data-fancybox="gallery">
										<img src="{{asset('images/details/06.jpg')}}" alt="gallery">
									</div>
								</div>
								...
								<div class="swiper-slide">
									<div class="gallery-large" data-src="{{asset('images/details/03.jpg')}}" data-fancybox="gallery">
										<img src="{{asset('images/details/03.jpg')}}" alt="gallery">
									</div>
								</div>
					...
					<div class="gallery-thumnail-gallery">
						<div class="thumnail-gallery">
							<div class="swiper-container gallery-thumbs">
								<div class="swiper-wrapper">
									<div class="swiper-slide"><img src="{{asset('images/details/01.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/02.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/03.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/04.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/05.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/06.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/01.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/02.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/03.jpg')}}" alt="gallery"></div>
									<div class="swiper-slide"><img src="{{asset('images/details/04.jpg')}}" alt="gallery"></div>
