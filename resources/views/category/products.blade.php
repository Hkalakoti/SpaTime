...
<div class="container-fluid text-center">
	<h1 class="wow fadeInDown" data-wow-delay="0.2s" data-wow-duration="1.5s">Balinese Massage</h1>
			<div class="row">
				<div class="col-lg-5 col-md-12 col-sm-12">
					<div class="gallery-main">
						<div class="swiper-container gallery-top">
							<div class="swiper-wrapper">
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/01.jpg" data-fancybox="gallery"><img src="images/details/01.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/02.jpg" data-fancybox="gallery"><img src="images/details/02.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/03.jpg" data-fancybox="gallery"><img src="images/details/03.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/04.jpg" data-fancybox="gallery"><img src="images/details/04.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/05.jpg" data-fancybox="gallery"><img src="images/details/05.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/06.jpg" data-fancybox="gallery"><img src="images/details/06.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/01.jpg" data-fancybox="gallery"><img src="images/details/01.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/02.jpg" data-fancybox="gallery"><img src="images/details/02.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/03.jpg" data-fancybox="gallery"><img src="images/details/03.jpg" alt="gallery"></div></div>
								<div class="swiper-slide"><div class="gallery-large" data-src="images/details/04.jpg" data-fancybox="gallery"><img src="images/details/04.jpg" alt="gallery"></div></div>
					...
					<div class="product-description">
						<h2>Balinese Massage by SPA TIME</h2>
						...
						<div class="cart-buy-btns"><button class="button detail-addtocart w-153"><a href="shopping-cart.html">Add to Cart</a></button> <button class="button detail-addtocart w-153"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 2.748l-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"></path></svg> Add to Wishlist</button></div>
